...
@section('styles')
    <meta property="og:title" content="Discover the latest job alerts in Kenya ({{date('Y')}})" />
    ...
    <div class="row">
        <div class="col-12 col-md-6 col-lg-6 p-3 p-lg-5">
            ...
            <div class="social mt-3 ">
              ...
              <p class="fs-5 fw-bold d-inline-block ms-2"><span>{{number_format($review->sum()/$review->count(),1)}}</span> based on <span>{{$review->count()}}</span> Reviews</p>
