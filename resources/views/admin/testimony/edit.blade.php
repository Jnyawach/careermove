...
<form action="{{route('testimony.update', $testimony->id)}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <div class="col-12 col-md-6 col-lg-4">
            ...
            <input type="text" name="first_name"  id="first_name" required value="{{$testimony->first_name}}"
        ...
        <div class="col-12 col-md-6 col-lg-4">
            ...
            <input type="text" name="last_name"  id="last_name" required value="{{$testimony->last_name}}"
           class="form-control mt-3">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            ...
            <input type="text" name="title"  id="title" required value="{{$testimony->title}}"
           class="form-control mt-3">
    ...
    <div class="form-group mt-3">
        ...
        <textarea class="form-control mt-2" id="content"
            style="height: 200px" name="content" required >{{$testimony->content}}</textarea>
    ...
    <div class="form-group row mt-3">
        <div class="col-12 col-md-6 col-lg-4">
            ...
            <select class="form-select mt-3" id="rating" name="rating" required>
                <option selected value="{{$testimony->rating}}">{{$testimony->rating}}</option>
