            ...
            <form action="{{route('languages.update', $language->id)}}" method="POST">
                ...
                <div class="form-group required row mt-3">
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <input type="text" name="name"  id="name" required value="{{$language->name}}"
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <select class="form-select mt-3" id="spoken" name="spoken" required >
                            <option selected value="{{$language->spoken}}">{{$language->spoken}}</option>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <select class="form-select mt-3" id="writen" name="writen" required >
                            <option selected value="{{$language->writen}}">{{$language->writen}}</option>
                            <option value="Basic">Basic</option>
                            <option value="Fluent">Fluent</option>
                            <option value="Native">Native</option>
