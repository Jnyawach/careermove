...
@section('title','Edit career Introduction')
@section('content')
<section class="dashboard-body p-3">
    <div class="card">
        ...
        <div class="card-body p-3">
            <form method="POST" action="{{route('summary.update',$summary->id)}}">
                @method('PATCH')
                @csrf
                <div class="form-group required">
                    ...
                    <textarea class="form-control mt-2" placeholder="Type summary here" id="summary"
                        style="height: 250px" name="summary" required>{{$summary->summary}}</textarea>
