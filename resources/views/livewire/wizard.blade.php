                    ...
                    <div class="card mt-5 p-lg-5">
                        <div class="card-body p-5">
                            <div class="form-group mt-2">
                                ...
                                <input type="text" name="name" wire:model="name" id="name" required
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" name="lastName" wire:model="lastName" id="lastName" required
                                       class="form-control mt-2">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="email" name="email" wire:model="email" id="email" required
                                       class="form-control mt-2">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="password" id="password"  class="form-control mt-2"
                                       name="password" required autocomplete="new-password" wire:model="password">
                            ...
                            <div class="form-group mt-5 row">
                                ...
                                <div class="col-6 text-end pe-3">
                                    <button type="button" class="btn btn-secondary" wire:click="firstStepSubmit">
                              ...
                              <h6>Experience Level</h6>
                                ...
                                <div class="form-check mt-3">
                                    <input class="form-check-input" type="radio" name="experienceId" id="experience{{$id}}"
                                           wire:model="experienceId" value="{{$id}}">
