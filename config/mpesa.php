    ...
    */
    ...
    'accounts' => [
        'staging' => [
            ...
            'initiator' => 'Careermove',
            'id_validation_callback' => 'https://ac47-105-163-16-140.in.ngrok.io?secret='.env('CONFIRMATION_KEY'),
            'lnmo' => [
                'paybill' => 174379,
                'shortcode' => 174379,
                'passkey' => env('LIPA_NA_MPESA_ONLINE_PASS_KEY'),
                'callback' => 'https://ac47-105-163-16-140.in.ngrok.io/callback?secret='.env('CONFIRMATION_KEY'),
            ]
        ],
